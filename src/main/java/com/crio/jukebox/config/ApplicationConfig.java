...
public class ApplicationConfig {
    ...
    private final IPlayPlaylistService playPlaylistService=new PlayPlaylistService(userRepository,songRepository,playlistRepository);
    ...
    private final Play_PlaylistCommand playPlaylistCommand=new Play_PlaylistCommand(playPlaylistService);
    private final Play_SongCommand playSongCommand=new Play_SongCommand(playPlaylistService);
